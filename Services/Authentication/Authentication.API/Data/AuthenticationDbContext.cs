    ...
    IdentityUserLogin<Guid>, IdentityRoleClaim<Guid>, IdentityUserToken<Guid>>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // default table name: ASPNETUSERCLAIMS
    ...
    private void ConfigureUser(EntityTypeBuilder<User> builder)
    {
        ...
        // Each User can have many entries in the UserRole joint table
...
// employee ABC (Senior) -> HR Roles -> Create Employee, Delete Employee, Edit Employee, Create Interviews
// employee XYZ (Junior) -> HR Roles
...
// UserLogins and UserTokens - these are related to third-party logins. When configured, these let users sign in with a Google or Facebook account (for example), instead od creating a password on your app.